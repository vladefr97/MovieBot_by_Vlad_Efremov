...
public class MovieFinder {
    ...
    private static final MovieJSONGetter MovieJSONGetter = new MovieJSONGetter();
    ...
    public List<Movie> getMoviesInTheatres() {
        ...
        JSONstring = getJSONString("movie/now_playing", "language=ru&page=1&region=ru");
        return getMoviesFromJSON(JSONstring);
    }

    public List<DetailedMovie> getMoviesDetailes(List<Integer> movieIDs) {
